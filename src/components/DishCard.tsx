  ...
  return (
    ...
    >
      <div className="relative bg-gradient-to-br from-green-100 to-green-200 h-48">
        <img
          src={dish.image || '/images/placeholder.svg'}
          alt={dish.name}
          ...
          onError={(e) => {
            ...
            target.src = `data:image/svg+xml,${encodeURIComponent(`
              <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="200" cy="120" r="35" fill="rgba(255,255,255,0.8)"/>
                <text x="200" y="135" font-family="Arial, sans-serif" font-size="24" text-anchor="middle" fill="#10B981">🍽️</text>
                ...
                <text x="200" y="255" font-family="Arial, sans-serif" font-size="12" text-anchor="middle" fill="#666">VegBite Kitchen</text>
              </svg>
            `)}`;
          }}
        />
